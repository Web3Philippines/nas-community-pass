...
This project and everyone participating in it is governed by the Nas.io Community Pass [Code of Conduct](https://github.com/web3phl/nas-community-pass/blob/main/CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to <opensource@wareneutron.com>.
...
Answering a question in [Discussions](https://github.com/web3phl/nas-community-pass/discussions) is one of the easiest ways to start contributing.
